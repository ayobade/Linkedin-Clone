...
const LeftSide = () => {
    return (
        <Container>
            <ProfileCard>
                <CardBackground />
                <ProfilePhoto src="/images/user.svg" alt="Profile" />
                <ProfileName>Ayobade Makinde</ProfileName>
                <ProfileTitle>UI/UX Designer</ProfileTitle>
                <ProfileLocation>Lagos, Lagos State</ProfileLocation>
                <CompanyInfo>
                    <CompanyIcon>🔶</CompanyIcon>
                    <CompanyName>Grazac</CompanyName>
                </CompanyInfo>
            </ProfileCard>
            ...
            <AnalyticsCard>
                <AnalyticsItem>
                    ...
                    <AnalyticsNumber>3</AnalyticsNumber>
                </AnalyticsItem>
            </AnalyticsCard>
            ...
            <PremiumCard>
                ...
                <PremiumOffer>
                    ...
                    <PremiumOfferText>Try 1 month for NGN0</PremiumOfferText>
                </PremiumOffer>
            </PremiumCard>
